...
/** @type {string} */
const CACHE_VERSION = '1738282975|135963706';
/** @type {string} */
const CACHE_PREFIX = 'Bad Hair Day-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Bad Hair Day.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Bad Hair Day.html","Bad Hair Day.js","Bad Hair Day.offline.html","Bad Hair Day.icon.png","Bad Hair Day.apple-touch-icon.png","Bad Hair Day.worker.js","Bad Hair Day.audio.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHABLE_FILES = ["Bad Hair Day.wasm","Bad Hair Day.pck"];
